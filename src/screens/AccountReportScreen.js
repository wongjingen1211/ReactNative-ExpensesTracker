...
const AccountReportScreen = () => {
    ...
    function renderChart() {
...

        {
            ...
            return (
                <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: '#e8e8e8' }}>
        ...
        const renderItem = ({ item }) => (
            ...
            >
                ...
                <View style={{ justifyContent: 'center' }}>
                    <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h3 }}>RM{item.y} - {item.label}</Text>
                </View>
            </TouchableOpacity>
        )
